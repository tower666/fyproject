...
from django.contrib.sitemaps import GenericSitemap  # sitemap用的
from django.contrib.sitemaps.views import sitemap   # sitemap用的
from blog.models import Entry                       # sitemap用的
