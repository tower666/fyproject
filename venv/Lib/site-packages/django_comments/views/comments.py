...
def post_comment(request, next=None, using=None):
    ...
    if not request.session.get('login',None) and not request.user.is_authenticated:  # 添加了
        return  redirect('/')   #   添加了
    ...
    if request.session.get('login', None):   #
        comment.user_name = request.session['screen_name']  #  添加了
        comment.user_img = request.session['profile_image_url']  #   添加了
