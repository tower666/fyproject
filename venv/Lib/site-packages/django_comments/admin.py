...
class CommentsAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        (
            _('Content'),
            {'fields': ('user', 'user_name', 'user_img','user_email', 'user_url', 'comment_title',
                        'comment','parent_comment')}
            # 此处添加'comment_title',parent_comment,'user_img'
        ),
        (
            _('Metadata'),
    ...
    list_display = ('comment_title','name', 'content_type', 'object_pk', 'ip_address', 'submit_date',
                    'is_public', 'is_removed')     # 此处添加'comment_title'
